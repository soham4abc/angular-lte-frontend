...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  public onLoginClicked(loginFormGroup) {
    ...
    // console.log(form.form.value.mobile);
    this.appService.postapi(payload, 'login')
    .subscribe(data => {
      console.log(data);
      if (data.body.message === 'Success') {
        // if (data.body.verification_required === 'yes') {
          // this.presentAlertMultipleButtons();
        // }
        // localStorage.setItem('isLoggedin', 'true');
        // localStorage.setItem('mobile', form.form.value.mobile);
